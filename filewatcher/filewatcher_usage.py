...
files_info_dict = filewatcher.get_files_info(directory='/home/krishna/mygit-repos/',filemask='*',recursively=True,sortbytime=False)

# Doesn't retrieve files information from sub-directories if recursively=False
files_info_dict = filewatcher.get_files_info(directory='/home/krishna/mygit-repos/',filemask='*',recursively=False,sortbytime=True)
